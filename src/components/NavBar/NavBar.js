        ...
        <ul className="nav navbar-nav navbar-right clearfix">
          ...
          <li className="dropdown">
            ...
            >
              <a className="dropdown-toggle">
                <Badge dot>
                  <Avatar src={user.imageUrl || require('assets/images/avatar.png')}>
                    {user.firstName || ''}
                  </Avatar>
                </Badge>
              </a>
...
const UserDropDown = props => (
  <ul className="dropdown-menu list-group dropdown-persist">
    ...
    <li className="list-group-item">
      <Link to="/accountsetting/editpwd">
        <a className="animated animated-short fadeInUp">
          <Icon type="key" antd /> 密码修改
        </a>
      </Link>
    </li>
    {/* <li className="list-group-item">
