...
export async function asyncRequest(payload) {
  ...
  //设置请求体
  // debugger;
  switch(other.method.toLowerCase()) {
    case 'get':
        other.data = {params:other.data}
        break;
    case 'delete':
        other.data = {data:other.data}
        break;
  }
  const _promise = other.method
    ? Net[other.method.toLowerCase()](url, other.data,_.omit([other,'data']))
    : Net['post'](url, other.data,_.omit([other,'data']));
